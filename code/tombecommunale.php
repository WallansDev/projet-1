...
<body>
    ...
    if (isset($valider) && !empty(trim($keywords))) {
        ...
        if (!$erreur) {
            $req = $db->prepare("SELECT IdCommunale, IFNULL(PlaceDispo, '--') AS PlaceDispo FROM TOMBECOMMUNALE WHERE IdCommunale = '$keywords';");
            ...
            if (@$afficher == "oui") { ?>
                <div id="row">
                    ...
                    <table class="table text-center table-dark">
                        ...
                        <?php echo "<td><a class='link' href='tombecommunale-details.php?id=" . $tab[$i]['IdCommunale'] . "'>n°" . $tab[$i]['IdCommunale'] . " </a></td>"; ?>
