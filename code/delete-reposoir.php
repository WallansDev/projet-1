...
<body>
        ...
        if (isset($_POST['deleteInputButton'])) {
            ...
            if (!$erreur) {
                try {
                    ...
                    if ($reposoirManager->VerifReposoirByIdReposoir($deleteInputValue)) {
                        $reposoir = $reposoirManager->getInfoByIdReposoir($deleteInputValue);
                        alertBox("success", "Redirection en cours...", "delete-reposoir-valid.php?id=" . $reposoir->getIdReposoir(), 1000);
                    } else {
    ...
    ?>
        <div class="container">
            <br>
            <h1 class="main-title text-center">Supprimer un casier : </h1>
            <br>
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <form class="card card-sm" method="post" novalidate>
                        <div class="card-body row no-gutters align-items-center">
                            ...
                            <div class="col">
                                <input pattern="[a-zA-Z0-9\s]" class="form-control form-control-lg form-control-borderless" name="deleteInputValue" type="search" placeholder="Entrer le numéro du casier à supprimer">
                            </div>&ensp;
                            <div class="col-auto">
