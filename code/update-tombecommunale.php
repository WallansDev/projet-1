...
<head>
    ...
    <title>Modifier une tombe communale - Mairie Belvianes-et-Cavirac</title>
</head>
...
<body>
    ...
    if (isset($_POST['updateTombeCommunale'])) {
        ...
        if (!$erreur) {
            try {
                $updateTombeCommunale = new TombeCommunale(['IdCommunale' => $id, 'PlaceDispo' => $placeDispo]);
                $tombeCommunaleManager->update($updateTombeCommunale);
                $addLogs = new Logs(['IdUtilisateur' => $_SESSION['IdUser'], 'MessageLogs' => "a modifier une tombe (tombe communale n°$id)", 'StatusLogs' => "success"]);
                $logsManager->add($addLogs);
                alertBox("success", "Modification effectuée.", "tombecommunale-details.php?id=$id", 1500);
    ...
    ?>
        <div class="container">
            ...
            <div class="text-center">
                <h3>Modification de la tombe communale n°<?php echo $tombeCommunale->getIdCommunale(); ?></h3>
                <br>
                <form method="post" action="" id="formUpdateTombeCommunale" novalidate>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-control-group col-md-3">
                            ...
                            <input type="submit" value="Ajouter" class="btn btn-success btn-lg" name="updateTombeCommunale">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        (function() {
            ...
            window.addEventListener("load", function() {
                var form = document.getElementById("formUpdateTombeCommunale")
